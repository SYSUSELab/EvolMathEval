...
class Xverse(BaseLLM):

    SOTA = 'XVERSE-65B-2'

    SUPPORT_MODEL_LIST = [
        'XVERSE-65B-2', 'XVERSE-MoE', 'XVERSE-Long', 'XVERSE-13B-2', 'XVERSE-7B'
    ]
    def __init__(
        self, 
        api_keys : list,
        ...
        self.clients = [openai.Client(base_url="https://api.xverse.cn/v1", api_key=api_key) for api_key in api_keys]
