...
class Dengjia(BaseLLM):

    SOTA = "DENGJIA-AI-2.0"

    MOST_RECOMMENDED_MODEL = ["DENGJIA-AI-2.0"]

    SUPPORT_MODEL_LIST = ["DENGJIA-AI-2.0", "DENGJIA-IMG-3.0"]
    ...
    def __init__(
        ...
        self.url = 'https://bidapi.dengjia-ai.com/bidapi/t2t/v1/chat/completions'
    ...
    def generation(self, content, api_key, temperature=0.1):
