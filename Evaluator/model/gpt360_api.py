...
class Gpt360(BaseLLM):

    SOTA = '360gpt2-pro'

    MOST_RECOMMENDED_MODEL = ['360gpt2-pro']

    # 支持的模型
    SUPPORT_MODEL_LIST =  ['360gpt2-pro', '360gpt-turbo', '360GPT_S2_V9', '360gpt-pro']
    ...
    def generation(self, content, client):
